...
//   КОМЕНТАР ВІД СТУДЕНТА: Задача легка, одразу зрозумів з умови, що потрібно зробити, але коли глянув на код, то зрозумів, що задача уже написана. Цікаво ви придумали)))